...
class HWSet:
    ...
    def update_database(self):
        ...
        # client = MongoClient("mongodb+srv://Javier:ECE461@cluster0.068zylu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0&tlsAllowInvalidCertificates=true")
